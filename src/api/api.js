...
import { BASE_RENDER_URL, BASE_DELIVERY_URL, BASE_RENDER_CONTEXT_URL } from './endpoints';
...
const fetcher = {
  get: (path, params) =>
    fetch(path, params)
      ...
      .then(parseJSON)
      .catch(e => {
        console.error("path: "+ path + " params: "+params+" errorMessage: "+e);
      }),
};

const getContentById = id => fetcher.get(`${BASE_RENDER_URL}/${id}`);

const getRenderContentById = id => fetcher.get(`${BASE_RENDER_CONTEXT_URL}/${id}`);
