...
const NavBar = ({ handleSearchOpen }) => {
  ...
  const companyLogo = useFetchElements(contentIds.companyInformation);
  const logo = window.location.hostname == "localhost" ? DOMAIN_NAME + companyLogo?.companylogo.url : companyLogo?.companylogo.url;
